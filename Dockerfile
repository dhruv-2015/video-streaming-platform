...
# # COPY --from=installerprodapi /app .

# # Automatically leverage output traces to reduce image size
# # https://nextjs.org/docs/advanced-features/output-file-tracing
# # COPY --from=installerapi --chown=express:nodejs /app/out .
# COPY --from=installerapi --chown=express:nodejs /app .
# # COPY --from=installerapi --chown=express:nodejs /app/apps/api/dist /app/apps/api/dist
# # COPY --from=installerapi --chown=express:nodejs /app/packages/database/generated /app/packages/database/generated
